      ...
      <section id="profile">
         ...
         <div className="member-detail p-6">
            <div className="bg-white rounded-md overflow-hidden shadow-lg">
               ...
               <div className="flex items-center justify-between relative py-4 px-5">
                  <img src={require(`../../assets/images/avatars/${image}`)} alt={image} className="w-28 h-28 rounded-full absolute -top-8 left-10 bg-cover border-4 border-neutral-400" />
                  <div className="ml-36">
