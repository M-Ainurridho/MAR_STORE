   ...
   return (
      <>
         {innerWidth < 768 ? (
            <>
               {isCollapse && (
                  <aside className={`bg-neutral-800 md:hidden block fixed left-0 top-0 bottom-0 w-3/5 sm:w-1/2 z-10 p-3 z-20 overflow-y-auto`}>
            ...
            <aside className={`bg-neutral-800 hidden md:block fixed left-0 top-0 bottom-0 ${isCollapse ? "md:w-5%" : "md:w-1/4 lg:w-1/5 p-3"} overflow-y-auto`}>
